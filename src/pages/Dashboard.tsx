                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {project.pkey} • {project.template} • {project.lastAccessed}
                        </p>
                      </div>
                    ...
                    >
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className={`lozenge ${
                          issue.status === 'In Progress' ? 'lozenge-inprogress' :
                          issue.status === 'In Review' ? 'lozenge-moved' :
                          'lozenge-default'
                        }`}>
                          {issue.status}
                        </span>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <span className={`text-xs px-1.5 py-0.5 rounded ${
                          issue.priority === 'Highest' ? 'bg-destructive/10 text-destructive' :
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm">
                        <span className="font-medium">Sagar Sharma</span> updated{' '}
                        <span className="text-primary">PROJ-123</span>
                      </p>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm">
                        ...
                        <span className="text-primary">MRTT-45</span>
                      </p>
